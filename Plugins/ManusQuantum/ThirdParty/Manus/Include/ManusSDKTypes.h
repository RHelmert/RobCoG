...
typedef struct TrackerData
{
	...
	TrackerType_t trackerType; //default = TrackerType::TrackerType_Unknown;
...
{
	bool skeletalData; //default = false;
	bool recordingAndPlayback; //default = false;
	bool timeCode; //default = false;
	bool pluginsIcIdoVredSiemens; //default = false;
