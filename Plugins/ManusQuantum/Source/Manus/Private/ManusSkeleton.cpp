...
#else
    return SkeletalMesh->RefSkeleton.GetRawRefBoneInfo();
#endif    
}
...
#else
    USkeleton* t_Skeleton = SkeletalMesh->Skeleton;
#endif
...
bool UManusSkeleton::ToSkeletonSetup(SkeletonSetupInfo& t_SKL)
{
	...
	{
		t_Settings.targetType = SkeletonTargetType::SkeletonTarget_AnimationData;
